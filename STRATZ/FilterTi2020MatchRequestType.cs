...
namespace STRATZ
{
    public partial class FilterTi2020MatchRequestType : IGraphQlInputObject
    {
        ...
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        [JsonConverter(typeof(QueryBuilderParameterConverter<Ti2020CustomGameMatchDifficultyType?>))]
        #endif
        public QueryBuilderParameter<Ti2020CustomGameMatchDifficultyType?> Difficulty
        {
            get { return (QueryBuilderParameter<Ti2020CustomGameMatchDifficultyType?>)_difficulty.Value; }
        ...
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        [JsonConverter(typeof(QueryBuilderParameterConverter<FilterTi2020CustomGameMatchOrderBy?>))]
        #endif
        public QueryBuilderParameter<FilterTi2020CustomGameMatchOrderBy?> OrderBy
        {
            get { return (QueryBuilderParameter<FilterTi2020CustomGameMatchOrderBy?>)_orderBy.Value; }
