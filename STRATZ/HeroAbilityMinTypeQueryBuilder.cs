...
namespace STRATZ
{
    public partial class HeroAbilityMinTypeQueryBuilder : GraphQlQueryBuilder<HeroAbilityMinTypeQueryBuilder>
    {
        ...
        public HeroAbilityMinTypeQueryBuilder WithBracketBasic(string alias = null, IncludeDirective include = null, SkipDirective skip = null)
        {
            return WithScalarField("bracketBasic", alias, new GraphQlDirective[] { include, skip });
        }

        public HeroAbilityMinTypeQueryBuilder ExceptBracketBasic()
        {
